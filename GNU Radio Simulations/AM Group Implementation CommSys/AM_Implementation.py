...
class AM_Implementation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (4*samp_rate//SPS), 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0.set_frequency((4*self.samp_rate//self.SPS))
