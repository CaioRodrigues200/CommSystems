...
class AM_Implementation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._loopF_range = qtgui.Range(0.001, 0.05, 0.001, 0.03, 200)
        ...
        self.qtgui_freq_sink_x_2_0_0_0_1.set_fft_average(1.0)
        ...
        self.qtgui_freq_sink_x_2_0.set_update_time(0.1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_0_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_freq_sink_x_2_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_2_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_rrc_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (1.6*self.samp_rate//self.SPS), 0.1, 2048))
